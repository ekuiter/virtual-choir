const translationMap = {
    en: {
        ...
        museScore: "MuseScore",
        cursorHelp: "Shows the current playback position in the sheet music.",
        cursorNone: "No cursor",
        cursorNormal: "Cursor (measure)",
    ...
    de: {
        ...
        museScore: "MuseScore",
        cursorHelp: "Zeigt die aktuelle Playback-Position in den Noten an.",
        cursorNone: "Kein Cursor",
        cursorNormal: "Cursor (Takt)",
        cursorNote: "Cursor (Note)",
        error: "Fehler",
        warning: "Warnung",
        rename: "Umbenennen",
